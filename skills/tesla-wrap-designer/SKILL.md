...
- On the Model Y Premium layout, left-side upright scenes rotate +90° in the flat file; right-side upright scenes rotate -90°. For hood art read by someone standing in front of the car facing the windshield, rotate the complete upright scene 180° in the flat file. The earlier 0° hood default was reported upside down in the vehicle and must not be reused for this viewing direction. Apply the same transform to faces, objects, scenery and text together, without mirroring. This correction is owner-reported, not Tesla certification; do not generalize it to other models. Other catalog orientations remain provisional where not verified.
